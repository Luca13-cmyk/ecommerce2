...
<head>
  ...
  <script src="https://www.google.com/recaptcha/api.js?render=6LfXYVIaAAAAAHexFH0p34MbedHInCabvxtC_HkH"></script>
    ...
    $('#form').submit(function(event) {
        event.preventDefault();
          ...
          grecaptcha.ready(function() {
              grecaptcha.execute('6LfXYVIaAAAAAHexFH0p34MbedHInCabvxtC_HkH', {action: '/admin/login'}).then(function(token) {
